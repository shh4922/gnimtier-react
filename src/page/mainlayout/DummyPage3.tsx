...
const DummyPage3 = () => {
    ...
    const {data:myRiotInfo,isError:riotError, error:riotInfoError} = useFetchRiotInfo(myInfo?.user.id)
    ...
    if(riotError && riotInfoError){
        return <div>등록된 라이엇 계정이 없음. 인증먼저하셈</div>
    }
